...
public enum SimulatorConfigurationError: LocalizedError, Sendable {
  ...
  public var errorDescription: String? {
    ...
    case .missingRuntimeMetadata(let identifier):
      return "Could not recover runtime metadata for identifier \(identifier ?? "unknown")"
    case .missingDeviceTypeMetadata(let identifier):
      return "Could not recover device type metadata for identifier \(identifier ?? "unknown")"
