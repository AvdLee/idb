...
@frozen public enum FBVideoStreamCodec: String, Sendable {
  case h264
  case hevc
}
...
@frozen public enum FBVideoStreamFormat: Hashable, Sendable {
...
@frozen public enum FBVideoStreamRateControl: Hashable, Sendable {
