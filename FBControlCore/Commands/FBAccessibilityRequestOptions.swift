...
@frozen public enum FBAccessibilityElementFilter: String, Sendable, CaseIterable {
...
@frozen public enum FBAXTraversal: String, Sendable, CaseIterable {
...
@frozen public enum FBAXTraversalStrategy: String, Sendable, CaseIterable {
