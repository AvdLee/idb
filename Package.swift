...
let package = Package(
  ...
  products: [
    ...
    .library(name: "FBSimulatorControl", targets: ["FBSimulatorControlBinary"]),
    .library(name: "FBControlCore", targets: ["FBControlCoreBinary"]),
    .library(name: "XCTestBootstrap", targets: ["XCTestBootstrapBinary"]),
    .library(name: "FBDeviceControl", targets: ["FBDeviceControlBinary"]),
  ],
  dependencies: [
  ...
  targets: [
    .binaryTarget(
      name: "FBSimulatorControlBinary",
      path: "SPM/xcframeworks/FBSimulatorControl.xcframework"
    ),
    .binaryTarget(
      name: "FBControlCoreBinary",
      path: "SPM/xcframeworks/FBControlCore.xcframework"
    ),
    .binaryTarget(
      name: "XCTestBootstrapBinary",
      path: "SPM/xcframeworks/XCTestBootstrap.xcframework"
    ),
    .binaryTarget(
      name: "FBDeviceControlBinary",
      path: "SPM/xcframeworks/FBDeviceControl.xcframework"
    ),
    .target(
